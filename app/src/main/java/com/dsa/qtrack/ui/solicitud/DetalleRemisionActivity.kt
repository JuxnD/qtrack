...
class DetalleRemisionActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_detalle_remision)
        ...
        Log.d("DetalleRemisionActivity", "Datos recibidos -> Tipo: $tipoSolicitud, Número: $solicitudNumero, Prioridad: $prioridad")
